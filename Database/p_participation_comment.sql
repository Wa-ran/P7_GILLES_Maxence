...
BEGIN
    ...
    START TRANSACTION READ ONLY;
		...
		SELECT JSON_OBJECT('id', commentaire.id, 'userId', utilisateur.id, 'nom', utilisateur.nom, 'prenom', utilisateur.prenom, 'contenu', commentaire.contenu, 'date', commentaire.date_creation)
		FROM commentaire
